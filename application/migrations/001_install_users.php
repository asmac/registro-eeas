...
class Migration_Install_Users extends CI_Migration {
	...
	public function up()
	{
		...
		$this->db->simple_query("INSERT INTO `users` (`name`, `user`, `pass`, `mail`, `active`, `created`) VALUES ('Administrador', 'admin', '09ae22c2c195d71cca64d461a1603332efb073d9', 'admin@localhost.com', 1, CURRENT_TIMESTAMP)");
